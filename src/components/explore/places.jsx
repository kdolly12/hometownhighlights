...
//         image: img1, // You can change this to the correct image for Bhattiprolu
//       },
//       {
//         id: 2,
...
//         image: img2, // Change to actual image for Sri Kalahasti
//       },
//       {
//         id: 4,
//         name: "Chittoor",
//         description: "Known for its rich heritage and temples.",
//         image: img3, // Change to actual image for Chittoor
//       },
//     ],
//   },
...
//       {images.map((item) => (
//         <div className="image-card" key={item.key} onClick={() => handleImageClick(item.key)}>
...
//                 <div className="image-card" key={place.id}>
//                   <img src={place.image} alt={place.name} className="image" />
//                   <p className="description">{place.name}: {place.description}</p>
//                 </div>
//               ))}
//             </div>
//           </div>
